...
Assistify is a high-quality Discord moderation solution. It's an all-around utility bot, meaning it's made to be used in many servers but built for YOUR server.
...
Assistify offers two verification methods:
...
- Links: Stops users from sending links.
